        ...
        <div className="flex flex-col lg:flex-row items-start justify-center gap-8">
          ...
          <div className="lg:w-1/3 bg-white shadow-lg rounded-lg p-6 flex flex-col">
            <p className="text-[18px] text-gray-700 leading-[1.8] mb-4 font-semibold">
              ...
              India from 1947 to 1950, was also known as the "unifier and the
              principal architect of modern India".
            </p>
            <p className="text-[18px] text-gray-700 leading-[1.8] font-semibold">
              The 565 self-governing princely states under direct British rule
              had been released from British suzerainty under his leadership by
