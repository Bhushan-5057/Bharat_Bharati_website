    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <header className="max-w-7xl mx-auto px-4 pt-10 pb-6">
        <div className="flex items-center justify-center text-gray-400 mb-2">
          ...
          <Landmark className="mx-3 w-5 h-5 text-gray-600" aria-hidden />
          <span className="tracking-widest opacity-60">:::::</span>
        </div>
        ...
        <div className="flex justify-center">
          {loading ? (
            ...
            <>
              ...
              {!imgError && (
                <img
                  src={`data:${getMime(mainImage.file_name)};base64,${
                    mainImage.data
                  }`}
        ...
        <section className="max-w-6xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {otherImages.map((img: any, idx: number) => (
              <div
                key={idx}
                className="rounded-lg overflow-hidden cursor-pointer shadow hover:shadow-lg transition"
      ...
      {isOpen && otherImages.length > 0 && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="relative max-w-full max-h-full">
            <img
              src={`data:${getMime(otherImages[photoIndex].file_name)};base64,${
                otherImages[photoIndex].data
              }`}
